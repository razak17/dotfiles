...
# Retired: Deno is now managed by install/programs/mise.sh. The legacy
...
print_step "Deno installer (retired)"
log "error" "The Deno installer is retired. Deno is managed by mise; run 'dot program mise'."
